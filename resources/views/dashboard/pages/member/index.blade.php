...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <a href="{{ url('dashboard/member/create') }}" class="btn btn-success float-end">Add Member</a>
            <div class="card">
                <div class="card-body">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item" href="#" title="Comming Soon">Make
                                                            Payment</a></li>
                                                    <li><a class="dropdown-item" href="{{url('dashboard/health-create',$member->id)}}" title="Comming Soon">Add Health Report</a></li>
                                                    <li>
