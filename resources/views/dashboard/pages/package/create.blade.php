...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <a href="{{ url('dashboard/package') }}" class="btn btn-success float-end">All Package</a>
            <div class="mainForm">
                <div class="row">
                    <div class="col-12 col-md-8 p-1">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ url('dashboard/package') }}">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="name" name="name"
                                            ...
                                            placeholder="Enter Trainer Name" value="{{ old('name') }}">
                                        @error('name')
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="price" name="price"
                                                    ...
                                                    placeholder="Enter Trainer Name" value="{{ old('price') }}">
                                                @error('price')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" id="duration" name="duration"
                                                    ...
                                                    placeholder="Enter Your phone" value="{{ old('duration') }}">
                                                @error('duration')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="services_include" name="services_include"
                                            class="form-control @error('services_include') is-invalid @enderror" placeholder="Enter services included">{{ old('services_include') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="benefit" name="benefit" class="form-control @error('benefit') is-invalid @enderror"
                                            placeholder="Enter additional benefits">{{ old('benefit') }}</textarea>
                                        @error('benefit')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="row">
                                        ...
                                        <select id="status" name="status"
                                            ...
                                            <option value="Running" @if (old('status') == 'Running') selected @endif>Running
                                            </option>
                                        ...
                                        <select id="trainer_id" name="trainer_id"
                                            ...
                                            <option value="{{$trainer->id}}" @if (old('trainer_id') == '{{$trainer->name}}') selected @endif>{{$trainer->name}}
                                            </option>
                                            @endforeach
                                        </select>
                                        @error('trainer_id')
