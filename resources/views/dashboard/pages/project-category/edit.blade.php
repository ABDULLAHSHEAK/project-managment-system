...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <a href="{{ url('dashboard/project-category') }}" class="btn btn-success float-end">Project Category</a>
            <div class="mainForm">
                <div class="row">
                    <div class="col-12 col-md-8 p-1">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ url('dashboard/project-category',$category->id) }}" >
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="project_category_name" name="project_category_name"
                                            ...
                                            placeholder="Enter project Category Name" value="{{ old('project_category_name',$category->category_name) }}">
