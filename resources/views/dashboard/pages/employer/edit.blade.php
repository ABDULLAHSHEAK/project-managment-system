            ...
            <div class="mainForm">
                <div class="row">
                    <div class="col-12 col-md-8 p-1">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ url('dashboard/employer', $employer->id) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="name" name="name"
                                            ...
                                            placeholder="Enter Employer Name" value="{{ old('name', $employer->name) }}">
                                        @error('name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror"
                                            placeholder="Enter your address">{{ old('address', $employer->address) }}</textarea>
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="note" name="note" class="form-control @error('note') is-invalid @enderror"
                                            placeholder="Enter your note">{{ old('note', $employer->note) }}</textarea>
                                        @error('note')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img class="bordered rounded"
                                            src="{{ asset('image/employer') }}/{{ $employer->img }}" alt="Employer Img"
                                            width="80">
                                    </div> <br>
