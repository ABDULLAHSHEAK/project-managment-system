                                ...
                                <div class="row">
                                    <div class="col-md-2 col-12">
                                        <div class="img text-center mb-2">
                                            <img class="rounded" src="{{asset('image/employer')}}/{{$data->img}}" alt="Employer Image" width="100">
                                        </div>
                                    </div>
                                    <div class="col-md-10 col-12">
                                        <ul style="font-size: 20px;font-weight:200">
                                            ...
                                            <li style="list-style: none"><b>Category :</b> {{$data->employerCategory->category_name}}</li>
