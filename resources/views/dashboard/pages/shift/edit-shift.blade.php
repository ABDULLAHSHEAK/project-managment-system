            ...
            <div class="mainForm">
                <div class="row">
                    <div class="col-12 col-md-8 p-1">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('update.shift',$data->id) }}">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="time" id="start_time" name="start_time"
                                            ...
                                            placeholder="Enter Your Last Name" value="{{ old('start_time',$data->start_time) }}">
                                        @error('start_time')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="time" id="end_time" name="end_time"
                                            ...
                                            placeholder="Enter Your end_time" value="{{ old('end_time',$data->end_time) }}">
                                        @error('end_time')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
