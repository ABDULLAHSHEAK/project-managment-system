            ...
            <div class="mainForm">
                <div class="row">
                    <div class="col-12 col-md-8 p-1">
                        <div class="card">
                            <div class="card-body">
                               <form method="POST" action="{{ url('dashboard/project',$project->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    {{-- name --}}
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" id="start_date" name="start_date"
                                                    ...
                                                    placeholder="Enter Project Start Date" value="{{ old('start_date',$project->start_date) }}">
                                                @error('start_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" id="deadline" name="deadline"
                                                    ...
                                                    placeholder="Enter Project deadline" value="{{ old('deadline',$project->deadline) }}">
                                                @error('deadline')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="summary" name="summary" class="form-control @error('summary') is-invalid @enderror"
                                            placeholder="Enter your summary">{{ old('summary',$project->summary) }}</textarea>
                                        @error('summary')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="container">
                                                    <input
                                                        ...
                                                        min="0" max="100" value="{{$project->completion_status}}"
                                                        oninput="updateOutput(this.value)">
                                                    <output id="output">{{$project->completion_status}}</output>
                                                </div>
                                                ...
                                                <select id="client_id" name="client_id"
                                                    ...
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            {{ old('client_id',$client->id) == $client->id ? 'selected' : '' }}>
                                                            {{ $client->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
