                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="bg-light p-3">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <h5>Client</h5>
                                                            <img width="50" class="rounded" src="{{asset('image/client')}}/{{$project->client->img}}" alt="Client Image">
                                                        </div>
                                                        <div class="col-md-6">
                        ...
                        <table id="tableData" class="table">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item"
                                                            href="{{asset('image/file')}}/{{$note->file}}">Download File</a>
                                                    </li>
                                                    <li>
                                ...
                                @endforeach
                                        ...
                                        <div class="row mt-3">
                                            <div class="bg-light p-3">
                                                <form action="{{url('/dashboard/project/'.$project->id.'/details') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
