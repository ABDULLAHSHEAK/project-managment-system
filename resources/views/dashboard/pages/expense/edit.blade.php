            ...
            <div class="mainForm">
                <div class="row">
                    <div class="col-12 col-md-8 p-1">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ url('dashboard/expense',$data->id) }}" >
                                    @csrf
                                    @method('PUT')
                                     <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="amount" name="amount"
                                            ...
                                            placeholder="Enter expense Amount" value="{{ old('amount',$data->amount) }}">
                                        @error('amount')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="note" name="note" class="form-control @error('note') is-invalid @enderror"
                                            placeholder="Enter your note">{{ old('note',$data->note) }}</textarea>
                                        @error('note')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    {{-- date  --}}
                                            <div class="mb-3">
                                                ...
                                                <input type="date" id="date" name="date"
                                                    ...
                                                    placeholder="Enter Task Start Date" value="{{ old('date',$data->date) }}">
                                                @error('date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
