            ...
            <div class="mainForm">
                <div class="row">
                    <div class="col-12 col-md-8 p-1">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ url('dashboard/note', $note->id) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="note" name="note" class="form-control @error('note') is-invalid @enderror"
                                            placeholder="Enter your note">{{ old('note', $note->note) }}</textarea>
                                        @error('note')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img class="bordered rounded"
                                            src="{{ asset('image/file') }}/{{ $note->file }}" alt="Note Img"
                                            width="80">
                                            <span>{{$note->file}}</span>
                                    </div> <br>
